...
import animationData from "../../../assets/animation/Banner2.mp4.lottie.json";
...
const FiroToken = () => {
  ...
  return (
    <div>
      <PaddedDiv y={isBigDesktop ? "8" : "7"} bg={theme.colors.brand.primary}>
        {isDesktop && (
          <Lottie
        ...
        >
          ...
          >
            Firo is the token powering the Firo network. By transacting with
            Firo, you have the option of keeping your transactons private and
