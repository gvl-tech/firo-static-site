              ...
              <div class="tabs">
                ...
                <div class="tab">
                  ...
                  <label class="tab-label" for="q2">
                    <h4>
                      As a truly private cryptocurrency, won’t Firo be used for
                      terrible things?
                    </h4>
                  </label>
                  <div class="tab-content">
                    <p>
                      ...
                      good and evil. However, we are firm believers that the net
                      good for Firo far outweighs the bad. We believe money
                      should be a public utility. In an increasingly digital age
                      that's moving away from digital cash, money has
                      increasingly been surveilled and used as a tool of control
                      of oppressive governments whereby they can choose what you
                      can spend on or even cut you off from your savings.
                    </p>
                    <p>
                      Privacy is also an essential element if we believe in
                      cryptocurrency being used as a medium of transfer. Without
                      privacy, businesses would be revealing who their suppliers
                      are, how much they're paying their employees or how much
                      they're receiving. Even paying for a cup of coffee with a
                      currency that has a transparent public ledger can
                      potentially reveal your holdings or addresses that are
                      connected to you. We expect privacy in our day to day
                      financial transactions and no one wants our bank
                    ...
                    <p>
                      ...
                      privacy cryptocurrencies often make the headlines for use
                      on the darknet or perceived illicit behaviour, these form
                      a very small proportion of overall transactions. Privacy
                      preserving cryptocurrencies also{" "}
                    ...
                    <p>
                      ...
                      privacy technology enabled by cryptography while retaining
                      options for any user to disclose their details should they
                      wish.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      cryptocurrency as an essential element in maintaining the
                      original goal of cryptocurrency: to be a public utility
                      for money. We have seen how freedom of commerce or even
                      access to our savings are things that are no longer things
                      that can be taken for granted and authoritarian
                      governments have increasingly used money as a tool of
                      control. As fiat currencies go increasingly digital with
                      some going as far as totally replacing physical cash, we
                      lose control over our own money instead relying on
                      intermediaries.
                    </p>
                    <p>
                      Bitcoin was originally created as an answer to this by
                      ensuring you can be self sovereign over your money and to
                      serve as uncensorable and unseizable money that isn't
                      controlled by any one entity. Bitcoin's lack of privacy
                      however has now made it much easier to seize or blacklist
                      funds and due to ossification of the protocol, is unlikely
                      to take serious steps to address this.
                    </p>
                    <p>
                      ...
                      that have inspired and shaped the designs of other privacy
                      protocols (for e.g. Triptych, Seraphis, Lelantus-MW).
                    </p>
                    <p>
                      For it to be truly a public utility that isn't beholden to
                      any one entity,
                    </p>
                    <p>
                      ...
                      however they want, as long as it does not infringe on the
                      well-being or individual liberty of others. We are also
                      big believers that freedom of commerce also facilitates
                      peace and prosperity across countries and cultures. By
                      guaranteeing financial privacy, Firo can directly
                      guarantee{" "}
                      <Link
                    ...
                    <p>
                      ...
                      cryptocurrencies, it is our aim in providing the strongest
                      level of privacy without sacrificing on trustlessness,
                      ease of use and relying on time tested cryptographic
                      building blocks.
                    </p>
                  </div>
                </div>
              ...
              <div class="tabs">
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      pseudo-anonymity. In blockchains without complete privacy,
                      it is the relationships and links between addresses that
                      can reveal private information about you. Every single
                      coin has an immutable history.
                    </p>
                    <p>
                      This is why{" "}
                    ...
                    <p>
                      Firo through the Lelantus protocol allows you to burn your
                      coins to destroy them so that they stop existing and then
                      redeem them later for coins that have no previous
                      transaction history. The process of burning and redeeming
                      breaks the links between addresses making transaction
                      graph analysis very difficult.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      show which were the coins you burnt. The freshly redeemed
                      coins appear as new coins with no previous transaction
                      history and hence have no linkage with the original coins
                      that were burnt. In Lelantus, input and change amounts are
                      also hidden.
                    </p>
                    <p>
                      Firo's upcoming privacy protocol Lelantus Spark takes this
                      idea further with all amounts being hidden and removing
                      the need to 'redeem'. Users can now pass these coins
                      directly between each other without having to expose the
                      output amount. It also adds Spark addresses that are
                      public shareable but cannot be looked up on the
                      blockchain.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      combines very high anonymity sets (~65,000) while relying
                      on well tested cryptographic building blocks that do not
                      require trusted setup.
                    </p>
                    <p>
                      This compares very favorably to existing solutions like
                      mixers or even ring signatures that typically have limited
                      anonymity sets per transaction (for e.g. Monero has a ring
                      size of 11). Models that rely on decoys also have
                      weaknesses where deanonymization becomes easier when{" "}
                      ...
                      to avoid reducing the effective anonymity set and if ring
                      sizes are not large enough, can be subject to{" "}
                      <Link to="https://eprint.iacr.org/2019/455">
                        Sybil attacks
                      </Link>
                      . Similarly, Mimblewimble based coins rely highly on high
                      transaction volumes in a block and also have{" "}
                      <Link to="https://medium.com/beam-mw/on-linkability-of-mimblewimble-da9ba71e83b4">
                        limited resistance towards Sybil attacks
                      </Link>
                      . Firo's use of large anonymity pools and sliding windows
                      greatly alleviate these problems.
                    </p>
                    <p>
                      Solutions relying on zkSNARKs such as the Zerocash
                      protocol used in Zcash offer almost global anonymity sets
                      but rely on complicated new cryptography and more exotic
                      assumptions. They also require a trusted setup which for
                      some represents an unacceptable compromise.
                    </p>
                    <p>
                      Firo aims to achieve a balance of high anonymity combined
                      with well-established cryptographic building blocks that
                      don't require trust. Lelantus Spark also is designed to be
                      modular that would allow parts to be switched out in an
                      easier fashion as cryptographic advancements come along
                      giving very good flexibility. Spark addresses are also
                      very flexible allowing for a variety of view keys for
                      selective transparency and also efficient
                      multisig/threshold signatures. They also do not require
                      interactivity and can be openly posted since they cannot
                      be searched on the blockchain giving enhanced receiver
                      privacy.
                    </p>
                    <p>
                      Also as Firo uses the sliding window approach to privacy
                      instead of decoys, existing chain analysis methods such as
                      used for ring signatures or coin mixers would not work.
                    </p>
                    <p>
                ...
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      especially with the deployment of Lelantus Spark! All our
                      official wallets already anonymize or prompt you to do so
                      using Lelantus by default but Lelantus Spark with its new
                      private Spark address system makes it much easier to fully
                      transition to privacy by default.
                    </p>
                    <p>
                      ...
                      therefore did not hide amounts. With zero knowledge proof
                      technology in its infancy, back then we felt it was
                      prudent to balance privacy with supply auditability to
                      ensure we could detect inflation should there be a flaw in
                      the technology.
                    </p>
                    <p>
                      ...
                      amounts are hidden but the output amount remains exposed.
                      Additionally, the anonymization function in Lelantus
                      requires the users private key and therefore required user
                      input to anonymize.
                    </p>
                    <p>
                      ...
                      blocks and added Spark addresses which allows funds to be
                      kept privately without revealing amounts and can be freely
                      shared without compromising privacy. Users can send funds
                      directly to Spark addresses and have them anonymized
                      immediately without needing recipient interaction.
                    </p>
                    <p>
                      With the deployment of Lelantus Spark later this year
                      (2023), all our official wallets will by default use Spark
                      addresses and all mining rewards will mandatorily go to
                      Spark addresses increasing the anonymity set. We will also
                      approach exchanges to support withdrawals to Spark
                      addresses. Some time after Spark deployment, Helsing (our
                      private masternode staking) will then be launched allowing
                      masternode collateral to be held in Spark addresses and
                      for masternode rewards to go into Spark addresses
                      directly. We are hopeful with these changes that the vast
                      majority of transactions will become private.
                    </p>
                    <p>
                      ...
                      up to using Spark addresses, transparent addresses can be
                ...
                <div class="tab">
                  ...
                  <label class="tab-label" for="q7">
                    <h4>
                      What are sliding windows as used in Lelantus and Lelantus
                      Spark?
                    </h4>
                  </label>
                  <div class="tab-content">
                    <p>
                      ...
                      that you want to be hiding in a big crowd. The more people
                      use private transactions the more it improves the privacy
                      of other transcations. Anonymity loves company! However
                      with the type of proofs we use, the bigger the crowd is,
                      the more computationally intensive each transaction is. As
                      such, the crowd cannot grow to infinite sizes. Spark finds
                      a middle ground between robust privacy and scalability.
                      Firo has picked 65,000 as the maximum size of the crowd
                      though this may increase with improved optimizations or
                    ...
                    <p>
                      ...
                      can't really tell which coins you're taking since they all
                      look the same. When the bucket becomes full, the protocol
                      opens a new bucket for people to start placing their coins
                      in. However, we don't want to start with a totally empty
                      bucket otherwise they would need to wait for other people
                      to throw their coins into the bucket before they can pull
                      coins out of it for good anonymity. As such, we take
                      16,000 coins from the previous bucket and dump it into the
                      new bucket so that there's already a big 'crowd' in the
                      new set. Hence each bucket has some overlapping coins and
                      this is what we call sliding windows!
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      ...
                      with ZCT's addressing system which then lead to Seraphis.
                      This is why the addressing structures are quite similar.
                      While similar to Spark, Seraphis is a framework rather
                      than a protocol with full implementation details and does
                      not yet have an academic style paper with full security
                      proofs unlike Lelantus Spark.
                    </p>
                    <p>
                      Seraphis makes design choices for Monero by using it to
                      scale ring sizes. Lelantus Spark on the other hand doesn't
                      use decoy sampling and instead relies on large pools of
                      anonymity combined with sliding windows between the pools.
                      This offers much greater anonymity per transaction and
                      avoids many of the problems with decoy selection
                      algorithms at the cost of performance which can be
                      mitigated with batching techniques.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      parameters which will later be destroyed. An easy analogy
                      is to imagine creating a lockbox with a key and then
                      throwing the key away.
                    </p>
                    <p>
                      Why it is called trusted setup is that you must trust the
                      person who created it, to actually destroy the parameters.
                      Zero knowledge proof privacy systems such as the Zerocoin
                      (as originally used in Firo and now deprecated) and
                      Zerocash (as used in Zcash, PirateChain, Komodo and
                      Horizen) protocol requires a trusted setup.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      allows someone to forge the proofs meaning that coins can
                      be created out of thin air leading to hyperinflation. In
                      privacy coins where amounts are obscured, such inflation
                      can also remain undetected.
                    </p>
                    <p>
                      There are ways to mitigate the risks of a trusted setup
                      such as using a multi-party ceremony that if in theory
                      works, requires all parties in the ceremony to collude. If
                      at least one party destroys their portion of the secret,
                    ...
                    <p>
                      For example, Zcash’s original Sprout MPC ceremony sparked
                      controversy because of binaries that were not{" "}
                      ...
                      <Link to="https://electriccoin.co/blog/zcash-counterfeiting-vulnerability-successfully-remediated/#background">
                        prevent a flaw from being exploited until it was patched
                      </Link>
                      ).
                    </p>
                  </div>
                ...
                <div class="tab">
                  ...
                  <label class="tab-label" for="q10">
                    <h4>
                      What is a zero-knowledge cryptographic proof, and how does
                      it work?
                    </h4>
                  </label>
                  <div class="tab-content">
                    <p>
                      A zero-knowledge proof is a cryptographic method to prove
                      that you know something without giving any other details
                      about it, except that the fact that you know it. For
                      example, zero-knowledge proofs could be used to show you
                      have assets of more than a million dollars, without
                      showing the exact amount you own or the transactions that
                      make it up.
                    </p>
                    <p>
                      Zero-knowledge proofs are an ideal fit for providing
                      privacy on blockchains. On a public blockchain, everyone
                      has to be able to verify the authenticity of transactions
                      and so every transaction is posted for everyone to see
                      along with its entire history.
                    </p>
                    <p>
                      Zero-knowledge proofs allow others to verify that a valid
                      transaction has happened without giving any other
                    ...
                    <p>
                      ...
                      people to burn their coins and redeem them later for brand
                      new ones with no previous transaction history without
                      showing which coins were burnt.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <label class="tab-label" for="q11">
                    <h4>
                      How does blockchain-tracking software work, and why is it
                      so dangerous to anonymity?
                    </h4>
                  </label>
                  <div class="tab-content">
                    <p>
                      To best understand how blockchain-tracking software works,
                      it helps to view Bitcoin as a kind of financial social
                      network. The same kinds of mechanisms used to break
                      privacy in social networks, by analyzing social network
                      topology, can be used to break privacy in the Bitcoin
                      network. By taking a pre-existing social network like
                      Facebook, we can use that information to generate
                      heuristics about who is transacting with whom on Bitcoin.
                    </p>
                    <p>
                      ...
                      information about the user such as name or username. Then,
                      by looking at the social network topology of the
                ...
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      on mainnet. Most other cryptocurrencies use a gossip model
                      whereby when they receive a transaction, they tell all
                      other nodes connected to it about the transaction. As a
                      result the transaction propagates quickly through the
                      network. The downside is that an adversary who can monitor
                      the network can see this chain reaction happening and can{" "}
                    ...
                    <p>
                      Dandelion++ obfuscates these type of analysis by changing
                      the way the transactions are broadcasted by randomly
                      choosing to tell one other node about the transaction or
                      to switch to gossip mode. This makes it harder to
                      associate a node with a particular transaction.
                    </p>
                    <p>
            ...
            <div class="col">
              ...
              <div class="tabs">
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      You can see all the exchanges and/or swap services Firo is
                      available{" "}
                      <Link to="https://firo.org/get-firo/buy-firo/">here</Link>{" "}
                      or on{" "}
                      <Link
                ...
                <div class="tab">
                  ...
                  <label class="tab-label" for="q15">
                    <h4>What is the total supply and distribution of Firo?</h4>
                  </label>
                  <div class="tab-content">
                    <p>
                      There will be 21.4 million Firos. Firo follows the same
                      distribution and halving cycle as Bitcoin (every 4 years).
                    </p>
                    <p>
                      The current block reward of 6.25 FIRO/block is divided as
                      follows:
                    </p>
                    <ul>
                ...
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      ...
                      Proof-of-Work (PoW). PoW enables community building, fair
                      distribution and ties the value of Firo to the physical
                      world with energy.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      optimized for GPU mining and designed to be both FPGA and
                      ASIC resistant to even the playing field and allow people
                      to mine from their own consumer hardware. We have always
                      been big fans of Proof of Work’s ability to tie the value
                      of a virtual currency to the real world along with a way
                      to distribute Firo’s supply in a fair and decentralized
                      manner free from restrictions.
                    </p>
                    <p>
                      FiroPoW follows{" "}
                ...
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      <Link to="https://firo.org/community/social/">here.</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="tabs">
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      Firo’s infrastructure and provide additional services such
                      as 51% mining attack protection via LLMQ chain locks and
                      instant sends
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      incentivized infrastructure, masternode holders can invest
                      in hardware that have higher specifications and are
                      motivated to keep the node updated and running. This helps
                      Firo’s blockchain scale and ensures a robust network of
                      nodes.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      This is because the <strong>1000 FIRO</strong> needs to be
                      sent to a new address in one transaction and the custody
                      is with one person. We ideally do not recommend such
                      arrangements unless you really trust the person holding
                      the funds on behalf of you. There is nothing to prevent
                      the person holding the masternode funds from running away
                      with your share.
                    </p>
                    <p>
                      ...
                      your operator key and the transaction ID of your 1000 FIRO
                      deposit.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      configuration that links the masternode to your 1000 FIRO
                      deposit. In the event of a masternode being hacked, all
                      that will happen is that your masternode will go offline
                      and you will lose your position in the payment queue.
                    </p>
                    <p>
                      Your local Firo wallet still holds the 1000 FIRO so it is
                      that wallet that will need to be secured. Ensure that your
                      wallet is frequently backed up and encrypt your wallet.
                    </p>
                    <p>
                      If you go with a masternode provider, all he requires is
                      your masternode private key and the transaction ID of your
                      1000 FIRO deposit. The masternode provider does not need
                      your private key to the funds. You also do not need to
                      send any funds to him.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      ...
                      providers who can simplify the process for you for a fee.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <label class="tab-label" for="q28">
                    <h4>How much are the rewards from hosting a masternode?</h4>
                  </label>
                  <div class="tab-content">
                ...
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <ul>
                      ...
                      <li>1 GB of RAM</li>
                      <li>
                        Enough disk space to store the blockchain (&gt;10 gb is
                        recommended for the moment)
                      </li>
                    </ul>
                    <p>
                      Typically a VPS of this specification costs around USD5 to
                      run a month per node and you can head on to Amazon AWS,
                      Google Cloud, Microsoft Azure, Leaseweb,{" "}
                      ...
                      to obtain a basic VPS when masternodes are launched. There
                      will also be masternodes providers who can assist you to
                      set this up and/or maintain it for a small fee.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      ...
                      Firo’s block reward (currently at 50% of the block reward)
                      in return for hosting a reliable and powerful node that
                      helps to support the network along with providing
                      additional services to the network. For example,
                      masternodes form themselves into long living masternode
                      quorums (LLMQs) that provide ChainLocks which secures the
                      chain against 51% mining attacks with single block
                      finality and InstantSend which allows transactions to be
                      finalized within a few seconds even before block
                      confirmation.
                    </p>
                    <p>
                      Masternodes require a refundable collateral of 1000 FIRO
                      to ensure masternode holders have a stake in FIRO and are
                      incentivized to keep it working honestly, updated often
                      and have a high uptime. This collateral can be transferred
              ...
              <div class="tabs">
                <div class="tab">
                  ...
                  <div class="tab-content">
                    ...
                    <p>
                      Being a BSC token, BEP20 Firo does not utilize the privacy
                      technology of Firo but can instead interact with defi
                      protocol, AMM DEXes and other smart contracts on the BSC
                      network.
                    </p>
                    <p>
                      You can obtain BEP20 Firo either by withdrawing from
                      Binance and selecting the BSC network instead of the Firo
                      network or by swapping it on FiroDEX.
                    </p>
                  </div>
                </div>
                <div class="tab">
                  ...
                  <div class="tab-content">
                    <p>
                      ...
                      or <Link to="https://t.me/firoorg">Telegram</Link> to ask
                      any questions!
                    </p>
                  </div>
                </div>
